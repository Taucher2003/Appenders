...
import com.github.taucher2003.appenders.utils.buckets.GitlabBucket;
import okhttp3.OkHttpClient;
import org.slf4j.Marker;

/**
 * The {@link WebRequestExecutor} for Gitlab
 */
public class GitlabWebRequestExecutor extends WebRequestExecutor {
    /**
     * {@inheritDoc}
     */
    public GitlabWebRequestExecutor(Marker selfIgnoringMarker, OkHttpClient httpClient) {
    ...
    protected Bucket createBucket(Marker selfIgnoringMarker) {
        return new GitlabBucket(selfIgnoringMarker);
    }
}
