...
import com.github.taucher2003.appenders.core.gitlab.IssueAppender;
...
public final class Log4JIssueAppender extends AbstractLog4JGitlabAppender<IssueAppender> {

    // legacy support for log4j version before 2.11.2
    @Deprecated
    private Log4JIssueAppender(String name, String baseUrl, String repositoryId, String accessToken, boolean confidential, Filter filter, boolean ignoreExceptions, Object ignored) {
        super(new IssueAppender(), name, baseUrl, repositoryId, accessToken, filter, null, ignoreExceptions);
    ...
    public static Log4JIssueAppender createAppender(
        ...
        try {
            return new Log4JIssueAppender(name, baseUrl, repositoryId, accessToken, confidential, filter, ignoreExceptions);
        } catch (NoSuchMethodError ignored) {
            return new Log4JIssueAppender(name, baseUrl, repositoryId, accessToken, confidential, filter, ignoreExceptions, null);
        }
    }
}
