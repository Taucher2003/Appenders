...
public abstract class AbstractLog4JGitlabAppender<T extends AbstractGitlabAppender> extends AbstractLog4JWebAppender<T> {

    // legacy support for log4j version before 2.11.2
    @Deprecated
    protected AbstractLog4JGitlabAppender(T delegate, String name, String baseUrl, String repositoryId, String accessToken,
